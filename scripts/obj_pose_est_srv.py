...
from object_pose_estimator_server.srv import GetObjPose, GetObjPoseResponse
import numpy as np
...
if __name__ == "__main__":
    ...
    ext_cal_path = rospack.get_path('object_pose_estimator_server')+'/config/cam1_H_camX.pkl'
